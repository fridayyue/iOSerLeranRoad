...
- (void)configCollectionView {
  ...
  _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.lpd_width, _itemWH+30) collectionViewLayout:layout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if(_selectedPhotos.count<_maxSelectedCount) {
    if (indexPath.row == _selectedPhotos.count) {
        //submit_photo  AlbumAddBtn.png
//      [cell.imageThumbnail setImage:[UIImage imageNamedFromMyBundle:@"AlbumAddBtn.png"]];
     [cell.imageThumbnail setImage:[UIImage imageNamed:@"submit_photo"]];
