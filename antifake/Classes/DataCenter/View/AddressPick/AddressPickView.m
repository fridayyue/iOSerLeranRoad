...
#define kScreenWidth  ZFScreenW
#define kScreenHeight  ZFScreenH
...
-(void)_createView
{
    ...
    for (int i = 0; i <buttonTitleArray.count ; i++) {
        ...
        i==0?[button setTitleColor:[UIColor grayColor] forState:UIControlStateNormal]:nil;
...
-(void)showBottomView
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self->_bottomView.frame = CGRectMake(self->_bottomView.frame.origin.x, kScreenHeight-navigationViewHeight-pickViewViewHeight, self->_bottomView.frame.size.width, self->_bottomView.frame.size.height);
...
{
    [UIView animateWithDuration:0.3 animations:^{
        self->_bottomView.frame = CGRectMake(self->_bottomView.frame.origin.x, kScreenHeight, self->_bottomView.frame.size.width, self->_bottomView.frame.size.height);
        self.backgroundColor = [UIColor clearColor];
    } completion:^(BOOL finished) {
